...
# openai.api_key = "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"
openai.api_key = os.getenv('OPENAI_API_KEY')

# Объект бота

proxy_url = 'http://proxy.server:3128'
# bot = Bot(token="6017269099:AAEk8zDIWNGnyWkinRUcdwE3wQLRCna36vo", proxy=proxy_url)
bot = Bot(token=os.getenv('TELEGRAM_TOKEN'), proxy=proxy_url)
